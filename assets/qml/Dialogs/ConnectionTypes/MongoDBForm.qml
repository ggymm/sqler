        ...
        ScrollView {
            ...
            ColumnLayout {
                ...
                GridLayout {
                    ...
                    SpinBox { Layout.fillWidth: true; Layout.preferredWidth: theme.formInputWidth; from: 1; to: 65535; value: root.conn ? (root.conn.port || 27017) : 27017; onValueChanged: if (root.conn) root.conn.port = value; background: Rectangle { color: parent.activeFocus ? theme.backgroundColor : theme.inputFieldBackground; border.color: parent.activeFocus ? theme.inputFieldActiveBorder : theme.inputFieldBorder; border.width: 1; radius: theme.radiusSmall } }
                    ...
                    TextField { Layout.fillWidth: true; Layout.preferredWidth: theme.formInputWidth; text: root.conn ? root.conn.database : ""; onTextChanged: if (root.conn) root.conn.database = text; background: Rectangle { color: parent.activeFocus ? theme.backgroundColor : theme.inputFieldBackground; border.color: parent.activeFocus ? theme.inputFieldActiveBorder : theme.inputFieldBorder; border.width: 1; radius: theme.radiusSmall } }
                }
            }
        }
    }
