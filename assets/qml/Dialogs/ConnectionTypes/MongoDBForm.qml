    ...
    Rectangle {
        ...
        ScrollView {
            ...
            ColumnLayout {
                ...
                Label { text: "MongoDB 连接配置"; font.bold: true; font.pixelSize: theme.fontSizeTitle; color: theme.textPrimary; Layout.alignment: Qt.AlignHCenter }
                ...
                GridLayout {
                    ...
                    SpinBox {
                        ...
                        from: 1
                        to: 65535
                        value: root.conn ? (root.conn.port || 27017) : 27017
                    ...
                    Label { text: "用户名(可选)"; color: theme.textPrimary; font.pixelSize: theme.fontSizeNormal; Layout.preferredWidth: theme.formLabelWidth }
                    TextField { Layout.fillWidth: true; Layout.preferredWidth: theme.formInputWidth; text: root.conn ? root.conn.user : ""; onTextChanged: if (root.conn) root.conn.user = text; color: theme.inputTextColor; placeholderTextColor: theme.inputPlaceholderColor; selectionColor: theme.inputSelectionColor; selectedTextColor: theme.inputSelectedTextColor; background: Rectangle { color: parent.activeFocus ? theme.backgroundColor : theme.inputFieldBackground; border.color: parent.activeFocus ? theme.inputFieldActiveBorder : theme.inputFieldBorder; border.width: 1; radius: theme.radiusSmall } }

                    Label { text: "密码(可选)"; color: theme.textPrimary; font.pixelSize: theme.fontSizeNormal; Layout.preferredWidth: theme.formLabelWidth }
                    TextField { Layout.fillWidth: true; Layout.preferredWidth: theme.formInputWidth; text: root.conn ? root.conn.password : ""; echoMode: TextInput.Password; onTextChanged: if (root.conn) root.conn.password = text; color: theme.inputTextColor; placeholderTextColor: theme.inputPlaceholderColor; selectionColor: theme.inputSelectionColor; selectedTextColor: theme.inputSelectedTextColor; background: Rectangle { color: parent.activeFocus ? theme.backgroundColor : theme.inputFieldBackground; border.color: parent.activeFocus ? theme.inputFieldActiveBorder : theme.inputFieldBorder; border.width: 1; radius: theme.radiusSmall } }

                    Label { text: "数据库(可选)"; color: theme.textPrimary; font.pixelSize: theme.fontSizeNormal; Layout.preferredWidth: theme.formLabelWidth }
                    TextField { Layout.fillWidth: true; Layout.preferredWidth: theme.formInputWidth; text: root.conn ? root.conn.database : ""; onTextChanged: if (root.conn) root.conn.database = text; color: theme.inputTextColor; placeholderTextColor: theme.inputPlaceholderColor; selectionColor: theme.inputSelectionColor; selectedTextColor: theme.inputSelectedTextColor; background: Rectangle { color: parent.activeFocus ? theme.backgroundColor : theme.inputFieldBackground; border.color: parent.activeFocus ? theme.inputFieldActiveBorder : theme.inputFieldBorder; border.width: 1; radius: theme.radiusSmall } }
                }
            }
        }
    }
